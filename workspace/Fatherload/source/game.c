...
void start_game(){
	...
	printDigitSmall(0, 16, 1);
	printDigitSmall(1, 18, 1);
	printDigitSmall(2, 20, 1);
	printDigitSmall(3, 22, 1);
	printDigitSmall(4, 24, 1);
	printDigitSmall(5, 26, 1);
	printDigitSmall(6, 28, 1);
	printDigitSmall(7, 30, 1);
}
